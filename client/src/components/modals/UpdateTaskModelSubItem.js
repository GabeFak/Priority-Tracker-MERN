  ...
  return (
        <div className='input-feild' >
            ...
            <div className='row'>
              ...
              <p>
                <label>
                  <input style={{opacity: "1", pointerEvents: "all" }}type="checkbox" className="filled-in" checked={sub[1]} value={sub[1]} 
                  onChange={e => { const tempSubTaskIO = [...taskUpdate.subTasks]; 
                    tempSubTaskIO[index][1]=!tempSubTaskIO[index][1]; setTaskUpdate({...taskUpdate, subTasks: tempSubTaskIO})}}/>
                </label>
              </p>
